...
def main(page: ft.Page):
    ...
    # NOMBRE ACTUALIZADO: Frais Transport Saint-Domingue
    transporte_input = ft.TextField(label="Frais Transport Saint-Domingue", width=240, value="0", border_radius=10, visible=False)
    ...
    def procesar_factura(e):
        ...
        # Sumatoria estricta incluyendo el transporte
        ...
        def construir_pdf(incluir_frais):
            ...
            # NOMBRE ACTUALIZADO EN EL PDF: Frais Transport Saint-Domingue
            if empresa_select.value == "CREATIVITE":
        ...
        ft.Container(
            content=ft.Column(
                [
                    ...
                    ft.Row([tva_input, manutencion_input, diversos_input], alignment="center"),
                    # Fila separada para el transporte para que no rompa las 3 columnas de arriba y tenga espacio para el texto largo
                    ft.Row([transporte_input], alignment="center"),
                    ft.Container(
                        content=tabla,
                        border=ft.Border(
